...
static irqreturn_t misc_hall_irq(int irq, void *data)
{
	...
	if(gpio_value){
		...
		input_event(rmi4_data->input_dev, EV_KEY, KEY_SHOP, 1);
		input_sync(rmi4_data->input_dev);
		input_event(rmi4_data->input_dev, EV_KEY, KEY_SHOP, 0);
		input_sync(rmi4_data->input_dev);
	}
	else{
		/*hall near*/
		...
		input_event(rmi4_data->input_dev, EV_KEY, KEY_SPORT, 1);
		input_sync(rmi4_data->input_dev);
		input_event(rmi4_data->input_dev, EV_KEY, KEY_SPORT, 0);
		input_sync(rmi4_data->input_dev);
...
*/
	...
	set_bit(KEY_SPORT,rmi4_data->input_dev->keybit);
	input_set_capability(rmi4_data->input_dev, EV_KEY, KEY_SPORT);
	set_bit(KEY_SHOP,rmi4_data->input_dev->keybit);
	input_set_capability(rmi4_data->input_dev, EV_KEY, KEY_SHOP);
