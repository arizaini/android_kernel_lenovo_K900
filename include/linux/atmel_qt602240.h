...
#define ATMEL_QT602240_NAME "mxt224e"
...
//#define PROCG_NOISESUPPRESSION_T48                22u
...
/* Reserved */
#define T48_CFG_GCAFUL                          3 /* two bytes */
#define T48_CFG_GCAFLL                          5 /* two bytes */
#define T48_CFG_ACTVGCAFVALID                   7
#define T48_CFG_NOISETHR                        8
/* Reserved */
#define T48_CFG_FREQHOPSCALE                    10
#define T48_CFG_FREQ                            11 /* five bytes */
#define T48_CFG_IDLEGCAFVAILD                   16

#define T48_MSG_STATUS                          1
#define T48_MSG_GCAFDEPTH                       2
#define T48_MSG_FREQINDEX                       3

#define T48_MSG_STATUS_FHCHG                    BIT(0)
#define T48_MSG_STATUS_GCAFERR                  BIT(2)
#define T48_MSG_STATUS_FHERR                    BIT(3)
#define T48_MSG_STATUS_GCAFCHG                  BIT(4)
...
#define T46_CFG_CMD                             1
#define T46_CFG_MODE                            2
#define T46_CFG_IDLEGCAFDEPTH                   3
#define T46_CFG_ACTVGCAFDEPTH                   4
#define T46_CFG_VOLTAGE                         5
